...
public class rock_3d<T extends RockProjectileEntity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 16).addBox(-8.0F, -3.0F, -4.0F, 9.0F, 7.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-5.0F, -5.0F, -4.5F, 10.0F, 7.0F, 9.0F, new CubeDeformation(0.0F))
				.texOffs(2, 2).mirror().addBox(-2.0F, -2.0F, -3.5F, 10.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 7.0F, 0.0F));
