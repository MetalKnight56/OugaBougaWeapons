...
public class StickLongRecipe extends CustomRecipe {
	public StickLongRecipe(ResourceLocation pId, CraftingBookCategory pCategory) {
		super(pId, pCategory);
	}
	...
	public ItemStack assemble(CraftingContainer pContainer, RegistryAccess pRegistryAccess) {
		...
		return !itemstack.isEmpty() && !list.isEmpty() ? StickLongItem.dyeStickLong(itemstack, list) : ItemStack.EMPTY;
	}
